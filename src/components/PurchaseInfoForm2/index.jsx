...
function PurchaseInfoForm(props) {
  ...
  const validationSchema = Yup.object().shape({
    ...
    nameReceive: Yup.string().required("Vui lòng nhập họ tên người nhận"),
    addressReceive: Yup.string().required("Vui lòng nhập địa chỉ người nhận"),
    phoneReceive: Yup.string().required(
