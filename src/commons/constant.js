...
export const NAV_ITEM = [
	...
	},
	{
		id: '2', label: 'SNEAKERS', to: '/products', nav_nested: [
			{ id: '2.1', label: 'Adidas', to: '/products/adidas' },
			{ id: '2.2', label: 'Nike', to: '/products/nike' },
			{ id: '2.3', label: 'Vans', to: '/products/vans' },
			{ id: '2.4', label: 'Converse', to: '/products/converse' },
			{ id: '2.5', label: 'Fila', to: '/products/fila' },
			{ id: '2.6', label: 'Reebok', to: '/products/reebok' },
			{ id: '2.7', label: 'Puma', to: '/products/puma' },
			{ id: '2.8', label: 'Domba', to: '/products/domba' },
			{ id: '2.9', label: 'Asic', to: '/products/asic' },
		]
	},
